const STRINGS = {
  ko: {
    ...
    "admin.llm.extraHint": "Azure AD·OAuth 등 프로바이더별 옵션. 비워두면 기본값을 씁니다.",
    "admin.llm.save": "저장",
    "admin.llm.reset": "초기화",
  ...
  en: {
    ...
    "admin.llm.extraHint": "Provider-specific options such as Azure AD / OAuth. Leave empty for defaults.",
    "admin.llm.save": "Save",
